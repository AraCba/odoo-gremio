...
class Cargo(models.Model):
    ...
    nro_cargo = fields.Char(string="Número de cargo",
                            help="Se corresponde con el número del sistema universitario")
    ...
    dependencia = fields.Many2one(
        'docentes.dependencia.cargo', string='Dependencia')
    ...
    def name_get(self):
        result = []
        for record in self:
            result.append((record.tipo_cargo, record.docente))
